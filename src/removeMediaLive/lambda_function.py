...
def lambda_handler(event, context):
    ...
    stop_response = live_client.stop_channel(ChannelId=ChannelID)

    del_channel = live_client.delete_channel(ChannelId=ChannelID)
    del_input = live_client.delete_input(InputId=InputID)
    ...
    return respond(None, "Media Live Channel&Input being removed now...", response_body)
